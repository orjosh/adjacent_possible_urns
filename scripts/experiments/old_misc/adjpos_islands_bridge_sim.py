...
from islands_bridged_extension import IslandsBridgedMdlExt

experiment_tag = "adjpos_islands_bridge_run1"
...
if not exists(data_path):
    ...
    model = IslandsBridgedMdlExt(prob_core=prob_core, max_core=max_core, rng_seed=1234, \
